module.exports = class Init1657797447776 {
  name = 'Init1657797447776'
  ...
  async up(db) {
    ...
    await db.query(`CREATE TABLE "resource" ("id" character varying NOT NULL, "metadata_uri" text, CONSTRAINT "PK_e2894a5867e06ae2e8889f1173f" PRIMARY KEY ("id"))`)
    await db.query(`CREATE TABLE "token_resource" ("id" character varying NOT NULL, "token_id" character varying NOT NULL, "resource_id" character varying NOT NULL, CONSTRAINT "PK_435ef0917a04e91698042dff2bc" PRIMARY KEY ("id"))`)
    await db.query(`CREATE INDEX "IDX_127eeb3f3ae0a5760ed1602b9d" ON "token_resource" ("token_id") `)
    await db.query(`CREATE INDEX "IDX_1fb20b7a95a63bba235adcdb98" ON "token_resource" ("resource_id") `)
    ...
    await db.query(`ALTER TABLE "token_resource" ADD CONSTRAINT "FK_127eeb3f3ae0a5760ed1602b9db" FOREIGN KEY ("token_id") REFERENCES "token"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
    await db.query(`ALTER TABLE "token_resource" ADD CONSTRAINT "FK_1fb20b7a95a63bba235adcdb98e" FOREIGN KEY ("resource_id") REFERENCES "resource"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`)
  ...
  async down(db) {
    ...
    await db.query(`DROP TABLE "token_resource"`)
    await db.query(`DROP INDEX "public"."IDX_127eeb3f3ae0a5760ed1602b9d"`)
    await db.query(`DROP INDEX "public"."IDX_1fb20b7a95a63bba235adcdb98"`)
    ...
    await db.query(`ALTER TABLE "token_resource" DROP CONSTRAINT "FK_127eeb3f3ae0a5760ed1602b9db"`)
    await db.query(`ALTER TABLE "token_resource" DROP CONSTRAINT "FK_1fb20b7a95a63bba235adcdb98e"`)
